...
import com.miao.logmobile.parser.hourly.hourly_user.HourlyUserMapper;
import com.miao.logmobile.parser.hourly.hourly_user.HourlyUserReducer;
import com.miao.logmobile.parser.hourly.hourly_user.HourlyUserRunner;
...
public class HourlySessionRunner implements Tool {


    private static final Logger logger = Logger.getLogger(HourlySessionRunner.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            int status = ToolRunner.run(new HourlySessionRunner(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "hourly_session");

        job.setJarByClass(getClass());

        job.setNumReduceTasks(4);

        job.setMapperClass(HourlySessionMapper.class);
        ...
        job.setReducerClass(HourlySessionReducer.class);
