...
public interface IReduceOutputFormat {
    ...
    void buildSelectPs(IDimensionInfo iDimensionInfo, StatsBaseDimension key, StatsBaseOutputDimension value, PreparedStatement ps);

    String buildInsertSql(KpiTypeEnum kpiTypeEnum, Configuration conf);

    String buildSelectSql(KpiTypeEnum kpiTypeEnum, Configuration conf);
}
