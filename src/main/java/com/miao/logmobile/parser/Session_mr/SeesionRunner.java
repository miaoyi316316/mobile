...
public class SeesionRunner implements Tool {


    private static final Logger logger = Logger.getLogger(SeesionRunner.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            int status = ToolRunner.run(new SeesionRunner(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "session_");
